...
(async () => {
    ...
    let htmlOpen = `<a href="https://t.co/O3nre5gSrZ" target="_blank" rel="nofollow" onclick="closeSwallFromAdClick()"><img src="https://new.eduzone.my.id/Shope_MasaAIO.jpg" /></a>`;
